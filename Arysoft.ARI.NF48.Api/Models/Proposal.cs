...
namespace Arysoft.ARI.NF48.Api.Models
{
    public class Proposal : BaseModel
    {
        ...
        public CurrencyCodeType? CurrencyCode { get; set; } // Moneda en la que se aprueba la Propuesta

        public decimal? ExchangeRate { get; set; }          // Tipo de cambio a la fecha de aprobación de la Propuesta

        public decimal? TaxRate { get; set; }               // Valor porcentual del impuesto

        public bool? IncludeTravelExpenses { get; set; }    // Indica si los gastos de viaje están incluidos en la Propuesta
